...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='guangdong',
        help='ukbench/holidays/oxford5k/paris6k/pattern')

    parser.add_argument('--datadir', type=str, default='C:\\Users\\phs\\Desktop\\pytest\\dataset\\guangdong_test',
        help='dataset dir')

    parser.add_argument('--datapth', type=str, default='guangdong.pth',
    ...
    parser.add_argument('--ckp', type=str, default='C:\\Users\\phs\\Desktop\\pytest\\env\\mae_finetuned_vit_base.pth',
        help='checkpoint')

    parser.add_argument('--width', type=int, default=224,
        help='network input width size')
